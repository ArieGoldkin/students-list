...
const VALIDATOR_TYPE_MIN_NUMBER = "MIN_NUMBER";
...
export const VALIDATOR_MIN_NUMBER = () => ({
  type: VALIDATOR_TYPE_MIN_NUMBER,
});
export const VALIDATOR_EMAIL = () => ({ type: VALIDATOR_TYPE_EMAIL });
export const VALIDATOR_SELECT = (val) => ({
  type: VALIDATOR_TYPE_SELECT,
  val: val,
});
...
export const validate = (value, validators) => {
  ...
  for (const validator of validators) {
    ...
    if (validator.type === VALIDATOR_TYPE_MIN_NUMBER) {
